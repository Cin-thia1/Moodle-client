                        ...
                        <div id="overview" class="student-tab-content">
                            <div class="bg-white rounded-lg shadow-lg p-8">
                                ...
                                <dl class="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-6">
                                    ...
                                    <div class="flex flex-col"><dt class="text-sm font-medium text-gray-500">Sections</dt><dd class="text-lg text-gray-900 font-semibold">{{ $course->sections->count() }}</dd></div>
